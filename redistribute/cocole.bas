...
11HPRINT(6,3),"ABCDEFGHIJKLMNOPQRSTUVWXYZ":HCOLOR1:FORY=7TO17STEP2:FORX=15TO23STEP2:HLINE(X*8-3,Y*8-3)-(X*8+9,Y*8+9),PSET,B:NEXTX:NEXTY:G=1:HCOLOR5
...
64NEXTJ:X=I*2+13:Y=G*2+5:HCOLORC:HLINE(X*8-2,Y*8-2)-(X*8+8,Y*8+8),PSET,BF:HCOLOR0:HPRINT(X,Y),C$:POKE&HF015,&H21:IFINSTR(W$,C$)>0 THENHCOLOR1:HPRINT(6+ASC(C$)-ASC("A"),3),C$ ELSEHPRINT(6+ASC(C$)-ASC("A"),3)," "
