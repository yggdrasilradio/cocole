...
11HCOLOR5:HCOLOR1:FORY=7TO17STEP2:FORX=15TO23STEP2:HLINE(X*8-3,Y*8-3)-(X*8+9,Y*8+9),PSET,B:NEXTX:NEXTY:HCOLOR5:G=1
...
4000G$="":POKE&HF015,&H21:FORI=15TO23STEP2:HPRINT(I,5+(G*2))," ":NEXTI:PALETTE7,0:HCOLOR7:HPRINT(15,5+(G*2)),CHR$(127):HCOLOR5:T=0
...
4014IFC=13 THENPOKE&HF015,&HAA:RETURN
4015IFN>0 THENHPRINT(13+N2,R),RIGHT$(G$,1)
4016IFN<5 THENHCOLOR7:HPRINT(15+N2,R),CHR$(127):HCOLOR5
4017GOTO4010
